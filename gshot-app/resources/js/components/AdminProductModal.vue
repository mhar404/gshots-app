    ...
    >
        ...
        >
            ...
            <div class="flex-1 flex flex-col">
                <label class="text-gray-300 mb-1 text-sm sm:text-base">Image</label>

                <div v-if="previewImage || adminSelectedItem.image_url" class="w-full h-40 sm:h-48 md:h-56 rounded-xl mb-2 border border-white/20 overflow-hidden bg-black/40">
                    <img
                ...
                <div v-else class="w-full h-40 sm:h-48 md:h-56 rounded-xl mb-2 border border-white/20 bg-black/40 flex items-center justify-center text-gray-500">
                    No image provided
                </div>
            ...
            <div class="flex-1 flex flex-col justify-between">
                <div>
                    <label class="text-gray-300 text-sm sm:text-base">Name</label>
                    <input
                    ...
                    <div v-if="!adminSelectedItem.id">
                        <label class="text-gray-300 text-sm sm:text-base">Category</label>
                        <select
                        ...
                        >
                            <option value="" disabled class="bg-black text-white">Select Category</option>
                            ...
                            <option class="bg-black text-white">RiceMeals</option>
                        </select>
                    </div>

                    <label class="text-gray-300 text-sm sm:text-base">Description</label>
                    <textarea
                    ...
                    <label class="text-gray-300 text-sm sm:text-base">Price</label>
                    <input
                ...
                <div class="flex gap-3 mt-4">
                    ...
                    >
                        {{ adminSelectedItem.id ? "Save Changes" : "Add Product" }}
                    </button>
                </div>
            </div>
        </div>
